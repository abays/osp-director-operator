...
func (r *OpenStackEphemeralHeatReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.EphemeralHeatReady)
...
func (r *OpenStackEphemeralHeatReconciler) generatePasswordSecret(
	...
	if err != nil {
		if k8s_errors.IsNotFound(err) {
			...
			cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.EphemeralHeatCondWaitOnPassSecret)
...
func (r *OpenStackEphemeralHeatReconciler) ensureMariaDB(
	...
	if err != nil {
		...
		cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.EphemeralHeatCondMariaDBError)
		cond.Type = ospdirectorshared.ConditionType(ospdirectorshared.CommonCondTypeError)
		err = common.WrapErrorForObject(cond.Message, instance, err)
	...
	if len(mariadbPod.Status.ContainerStatuses) < 1 || !mariadbPod.Status.ContainerStatuses[0].Ready {
		...
		cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.EphemeralHeatCondWaitOnMariaDB)
		cond.Type = ospdirectorshared.ConditionType(ospdirectorshared.CommonCondTypeWaiting)
...
func (r *OpenStackEphemeralHeatReconciler) ensureRabbitMQ(
	...
	if err != nil {
		...
		cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.EphemeralHeatCondRabbitMQError)
		cond.Type = ospdirectorshared.ConditionType(ospdirectorshared.CommonCondTypeError)
		err = common.WrapErrorForObject(cond.Message, instance, err)
	...
	if len(rabbitmqPod.Status.ContainerStatuses) < 1 || !rabbitmqPod.Status.ContainerStatuses[0].Ready {
		...
		cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.EphemeralHeatCondWaitOnRabbitMQ)
		cond.Type = ospdirectorshared.ConditionType(ospdirectorshared.CommonCondTypeWaiting)
...
func (r *OpenStackEphemeralHeatReconciler) ensureHeat(
	...
	if err != nil {
		...
		cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.EphemeralHeatCondHeatError)
		cond.Type = ospdirectorshared.ConditionType(ospdirectorshared.CommonCondTypeError)
		err = common.WrapErrorForObject(cond.Message, instance, err)
	...
	if len(heatPod.Status.ContainerStatuses) < 1 || !heatPod.Status.ContainerStatuses[0].Ready {
		...
		cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.EphemeralHeatCondWaitOnHeat)
		cond.Type = ospdirectorshared.ConditionType(ospdirectorshared.CommonCondTypeWaiting)
