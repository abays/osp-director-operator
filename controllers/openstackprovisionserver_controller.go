...
func (r *OpenStackProvisionServerReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ProvisionServerCondTypeProvisioning)
	...
	if instance.Status.ProvisionIP != "" {
		...
		if err != nil {
			cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ProvisionServerCondTypeError)
			cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.OpenStackProvisionServerCondReasonLocalImageURLParseError)
		...
		if err != nil {
			cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ProvisionServerCondTypeError)
			cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.OpenStackProvisionServerCondReasonListError)
		...
		if podListLen > 1 {
			...
			cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ProvisionServerCondTypeWaiting)
			cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.OpenStackProvisionServerCondReasonListError)
		...
		for _, pod := range podList.Items {
			if pod.Status.Phase == corev1.PodRunning {
				cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ProvisionServerCondTypeProvisioned)
				cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.OpenStackProvisionServerCondReasonProvisioned)
...
func (r *OpenStackProvisionServerReconciler) getProvisioningInterfaceName(
	...
	if provInterfaceName != "" {
		...
		if err != nil {
			...
			cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.OpenStackProvisionServerCondReasonInterfaceAcquireError)
		...
		if provInterfaceName == "" {
			...
			cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.OpenStackProvisionServerCondReasonInterfaceNotFound)
			cond.Type = ospdirectorshared.ConditionType(ospdirectorshared.CommonCondTypeError)
...
func (r *OpenStackProvisionServerReconciler) deploymentCreateOrUpdate(
	...
	if err != nil {
		...
		cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.OpenStackProvisionServerCondReasonDeploymentError)
		cond.Type = ospdirectorshared.ConditionType(ospdirectorshared.CommonCondTypeError)
		err = common.WrapErrorForObject(cond.Message, instance, err)
	...
	if op != controllerutil.OperationResultNone {
		...
		cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.OpenStackProvisionServerCondReasonDeploymentCreated)
