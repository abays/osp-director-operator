...
func (r *OpenStackIPSetReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if !equality.Semantic.DeepEqual(
		...
		if err != nil {
			...
			cond.Reason = ospdirectorshared.CommonCondReasonAddOSNetLabelError
	...
	cond.Type = ospdirectorshared.CommonCondTypeProvisioned
...
func (r *OpenStackIPSetReconciler) createNewHostnames(
	...
	for i := 0; i < newCount; i++ {
		...
		if err != nil {
			...
			cond.Reason = ospdirectorshared.ConditionReason(ospdirectorshared.CommonCondReasonNewHostnameError)
			cond.Type = ospdirectorshared.ConditionType(ospdirectorshared.CommonCondTypeError)
			err = common.WrapErrorForObject(cond.Message, instance, err)
