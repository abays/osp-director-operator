...
func (r *OpenStackConfigGeneratorReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err != nil {
		...
		cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.ControlPlaneReasonNetNotFound)
		cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ConfigGeneratorCondTypeError)
	...
	if err != nil {
		cond.Message = err.Error()
		cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.ControlPlaneReasonNotSupportedVersion)
		cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ConfigGeneratorCondTypeError)
		err = common.WrapErrorForObject(cond.Message, instance, err)
	...
	if controlPlane.Status.ProvisioningStatus.State != ospdirectorv1beta1.ControlPlaneProvisioned {
		...
		cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.ConfigGeneratorCondReasonCMNotFound)
		cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ConfigGeneratorCondTypeWaiting)
		common.LogForObject(
			r,
			cond.Message,
			instance,
	...
	if err != nil {
		...
		cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.ConfigGeneratorCondReasonCMHashError)
		cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ConfigGeneratorCondTypeError)
		err = common.WrapErrorForObject(cond.Message, instance, err)
	...
	if instance.Status.ConfigHash != configMapHash {
		...
		if op != controllerutil.OperationResultNone {
			...
			cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.ConfigGeneratorCondReasonEphemeralHeatUpdated)
			cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ConfigGeneratorCondTypeInitializing)
			common.LogForObject(r, cond.Message, instance)
		...
		if !heat.Status.Active {
			...
			cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.ConfigGeneratorCondReasonEphemeralHeatLaunch)
			cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ConfigGeneratorCondTypeInitializing)
			common.LogForObject(r, cond.Message, instance)
		...
		if heat.Spec.ConfigHash != configMapHash {
			...
			if err != nil && !k8s_errors.IsNotFound(err) {
				cond.Message = err.Error()
				cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.ConfigGeneratorCondReasonCMHashChanged)
				cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ConfigGeneratorCondTypeError)
				err = common.WrapErrorForObject(cond.Message, instance, err)
			...
			cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.ConfigGeneratorCondReasonCMUpdated)
			cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ConfigGeneratorCondTypeInitializing)
			common.LogForObject(r, cond.Message, instance)
		...
		if !deployed {
			cond.Message = msg
			cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.ConfigGeneratorCondReasonWaitingNodesProvisioned)
			cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ConfigGeneratorCondTypeInitializing)
			common.LogForObject(r, cond.Message, instance)
		...
		if op != controllerutil.OperationResultNone {
			...
			cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.ConfigGeneratorCondReasonJobCreated)
			cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ConfigGeneratorCondTypeInitializing)
			common.LogForObject(r, cond.Message, instance)
		...
		if configMapHash != job.Spec.Template.Spec.Containers[0].Env[0].Value {
			...
			if err != nil {
				cond.Message = err.Error()
				cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.ConfigGeneratorCondReasonJobDelete)
				cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ConfigGeneratorCondTypeError)
				err = common.WrapErrorForObject(cond.Message, instance, err)
			...
			if err != nil && !k8s_errors.IsNotFound(err) {
				cond.Message = err.Error()
				cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.ConfigGeneratorCondReasonEphemeralHeatDelete)
				cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ConfigGeneratorCondTypeError)
				err = common.WrapErrorForObject(cond.Message, instance, err)
		...
		if err != nil {
			...
			cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.ConfigGeneratorCondReasonJobFailed)
			cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ConfigGeneratorCondTypeError)
			err = common.WrapErrorForObject(cond.Message, instance, err)
			...
			cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.ConfigGeneratorCondReasonConfigCreate)
			cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ConfigGeneratorCondTypeGenerating)
			common.LogForObject(r, cond.Message, instance)
		...
		if err != nil && !k8s_errors.IsNotFound(err) {
			cond.Message = err.Error()
			cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.ConfigGeneratorCondReasonExportFailed)
			cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ConfigGeneratorCondTypeError)
			err = common.WrapErrorForObject(cond.Message, instance, err)
	...
	cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.ConfigGeneratorCondReasonJobFinished)
	cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ConfigGeneratorCondTypeFinished)
...
func (r *OpenStackConfigGeneratorReconciler) createFencingEnvironmentFiles(
	...
	if controlPlane.Spec.EnableFencing {
		...
		if tripleoTarballCM != nil {
			...
			if err != nil {
				cond.Message = err.Error()
				cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.ConfigGeneratorCondReasonCustomRolesNotFound)
				cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ConfigGeneratorCondTypeError)
				err = common.WrapErrorForObject(cond.Message, instance, err)
		...
		for roleName, roleParams := range controlPlane.Spec.VirtualMachineRoles {
			if common.StringInSlice(roleParams.RoleName, fencingRoles) && roleParams.RoleCount == 3 {
				...
				if err != nil {
					cond.Message = err.Error()
					cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.ConfigGeneratorCondReasonVMInstanceList)
					cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ConfigGeneratorCondTypeError)
					err = common.WrapErrorForObject(cond.Message, instance, err)
		...
		if len(virtualMachineInstanceLists) > 0 {
			...
			if err != nil {
				cond.Message = err.Error()
				cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.ConfigGeneratorCondReasonFencingTemplateError)
				cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ConfigGeneratorCondTypeError)
				err = common.WrapErrorForObject(cond.Message, instance, err)
...
func (r *OpenStackConfigGeneratorReconciler) createTripleoDeployCM(
	...
	if err != nil {
		cond.Message = err.Error()
		cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.ConfigGeneratorCondReasonRenderEnvFilesError)
		cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ConfigGeneratorCondTypeError)
		err = common.WrapErrorForObject(cond.Message, instance, err)
	...
	if err != nil {
		cond.Message = err.Error()
		cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.ConfigGeneratorCondReasonClusterServiceIPError)
		cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ConfigGeneratorCondTypeError)
		err = common.WrapErrorForObject(cond.Message, instance, err)
	...
	if err != nil {
		cond.Message = err.Error()
		cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.ConfigGeneratorCondReasonCMCreateError)
		cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ConfigGeneratorCondTypeError)
		err = common.WrapErrorForObject(cond.Message, instance, err)
...
func (r *OpenStackConfigGeneratorReconciler) getClusterServiceEndpoint(
	...
	if err != nil {
		cond.Message = err.Error()
		cond.Reason = ospdirectorshared.ConditionReason(ospdirectorshared.CommonCondReasonServiceNotFound)
		cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ConfigGeneratorCondTypeError)
...
func (r *OpenStackConfigGeneratorReconciler) addConfigGeneratorInputLabel(
	...
	if _, ok := cm.Labels[openstackconfiggenerator.ConfigGeneratorInputLabel]; !ok {
		...
		if err != nil {
			cond.Message = err.Error()
			cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.ConfigGeneratorCondReasonInputLabelError)
			cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ConfigGeneratorCondTypeError)
			err = common.WrapErrorForObject(cond.Message, instance, err)
