...
func (r *OpenStackControlPlaneReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err != nil {
		if k8s_errors.IsNotFound(err) {
			...
			cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.OsClientCondReasonPodMissing)
		...
		cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.OsClientCondReasonPodError)
		cond.Type = ospdirectorshared.ConditionType(ospdirectorshared.CommonCondTypeError)
		err = common.WrapErrorForObject(cond.Message, instance, err)
	...
	if vmSetStateCounts[ospdirectorv1beta1.VMSetCondTypeProvisioning] > 0 {
		cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ControlPlaneProvisioning)
		cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.VMSetCondReasonProvisioning)
		...
		cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ControlPlaneDeprovisioning)
		cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.VMSetCondReasonDeprovisioning)
		...
		cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ControlPlaneWaiting)
		cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.VMSetCondReasonInitialize)
		...
		cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ControlPlaneProvisioned)
		cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.VMSetCondReasonProvisioned)
...
func (r *OpenStackControlPlaneReconciler) createOrGetTripleoPasswords(
	...
	if err != nil {
		if k8s_errors.IsNotFound(err) {
			...
			cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.ControlPlaneReasonTripleoPasswordsSecretError)
			cond.Type = ospdirectorshared.ConditionType(ospdirectorshared.CommonCondTypeError)
			err = common.WrapErrorForObject(cond.Message, instance, err)
	...
	if err != nil {
		if k8s_errors.IsNotFound(err) {
			...
			if err != nil {
				...
				cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.ControlPlaneReasonDeploymentSSHKeysGenError)
				cond.Type = ospdirectorshared.ConditionType(ospdirectorshared.CommonCondTypeError)
				err = common.WrapErrorForObject(cond.Message, instance, err)
			...
			if err != nil {
				...
				cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.ControlPlaneReasonDeploymentSSHKeysSecretCreateOrUpdateError)
				cond.Type = ospdirectorshared.ConditionType(ospdirectorshared.CommonCondTypeError)
				err = common.WrapErrorForObject(cond.Message, instance, err)
			...
			cond.Reason = ospdirectorshared.ConditionReason(ospdirectorshared.CommonCondReasonDeploymentSecretError)
			cond.Type = ospdirectorshared.ConditionType(ospdirectorshared.CommonCondTypeError)
			err = common.WrapErrorForObject(cond.Message, instance, err)
...
func (r *OpenStackControlPlaneReconciler) verifySecretExist(
	...
	if secretName != "" {
		...
		if err != nil {
			...
			cond.Reason = ospdirectorshared.ConditionReason(ospdirectorshared.CommonCondReasonSecretError)
			cond.Type = ospdirectorshared.ConditionType(ospdirectorshared.CommonCondTypeError)
			err = common.WrapErrorForObject(cond.Message, instance, err)
	...
	if configMapName != "" {
		...
		if err != nil {
			if k8s_errors.IsNotFound(err) {
				...
				cond.Reason = ospdirectorshared.ConditionReason(ospdirectorshared.CommonCondReasonConfigMapMissing)
				cond.Type = ospdirectorshared.ConditionType(ospdirectorshared.CommonCondTypeWaiting)
			...
			cond.Reason = ospdirectorshared.ConditionReason(ospdirectorshared.CommonCondReasonConfigMapError)
			cond.Type = ospdirectorshared.ConditionType(ospdirectorshared.CommonCondTypeError)
			err = common.WrapErrorForObject(cond.Message, instance, err)
...
func (r *OpenStackControlPlaneReconciler) createOrUpdateVMSets(
	...
	for _, vmRole := range instance.Spec.VirtualMachineRoles {
		...
		if err != nil {
			...
			cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.VMSetCondReasonError)
			cond.Type = ospdirectorshared.ConditionType(ospdirectorshared.CommonCondTypeError)
			err = common.WrapErrorForObject(cond.Message, instance, err)
		...
		cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.VMSetCondReasonCreated)
...
func (r *OpenStackControlPlaneReconciler) createOrUpdateOpenStackClient(
	...
	if err != nil {
		...
		cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.OsClientCondReasonError)
		cond.Type = ospdirectorshared.ConditionType(ospdirectorshared.CommonCondTypeError)
		err = common.WrapErrorForObject(cond.Message, instance, err)
	...
	cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.OsClientCondReasonCreated)
	cond.Type = ospdirectorshared.ConditionType(ospdirectorshared.CommonCondTypeCreated)
