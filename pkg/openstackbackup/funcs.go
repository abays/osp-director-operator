...
func CleanNamespace(r common.ReconcilerCommon, namespace string, crLists ospdirectorv1beta1.CrsForBackup, cmList corev1.ConfigMapList, secretList corev1.SecretList) (bool, error) {
	...
	// Delete OpenStackPlaybookGenerators as these should not be needed at this point
	if err := r.GetClient().DeleteAllOf(context.TODO(), &ospdirectorv1beta1.OpenStackPlaybookGenerator{}, client.InNamespace(namespace)); err != nil {
		return false, err
	}
