...
func CreateConfigMapParams(
	...
	if err != nil {
		...
		cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.NetCondReasonNetNotFound)
	...
	if err != nil {
		...
		cond.Reason = ospdirectorshared.ConditionReason(ospdirectorv1beta1.MACCondReasonMACNotFound)
		cond.Type = ospdirectorshared.ConditionType(ospdirectorv1beta1.ConfigGeneratorCondTypeError)
		err = common.WrapErrorForObject(cond.Message, instance, err)
