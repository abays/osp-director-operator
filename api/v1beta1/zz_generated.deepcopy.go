...
func (in *CrsForBackup) DeepCopyInto(out *CrsForBackup) {
	*out = *in
	...
	in.OpenStackIPSets.DeepCopyInto(&out.OpenStackIPSets)
...
func (in *OpenStackBackupRequestStatus) DeepCopyInto(out *OpenStackBackupRequestStatus) {
	*out = *in
	if in.VMSnapshotNames != nil {
		in, out := &in.VMSnapshotNames, &out.VMSnapshotNames
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
func (in *OpenStackIPSetSpec) DeepCopyInto(out *OpenStackIPSetSpec) {
	*out = *in
	...
	if in.HostNameRefs != nil {
		in, out := &in.HostNameRefs, &out.HostNameRefs
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
func (in *OpenStackIPSetStatus) DeepCopyInto(out *OpenStackIPSetStatus) {
	*out = *in
	...
	if in.Networks != nil {
		in, out := &in.Networks, &out.Networks
		*out = make(map[string]NetworkStatus, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
func (in *OpenStackMACAddressStatus) DeepCopyInto(out *OpenStackMACAddressStatus) {
	*out = *in
	if in.MACReservations != nil {
		...
		*out = make(map[string]OpenStackMACNodeStatus, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
func (in *OpenStackMACNodeStatus) DeepCopy() *OpenStackMACNodeStatus {
	if in == nil {
		return nil
	}
	out := new(OpenStackMACNodeStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OpenStackNetStatus) DeepCopyInto(out *OpenStackNetStatus) {
	*out = *in
	if in.RoleReservations != nil {
		...
		*out = make(map[string]OpenStackNetRoleStatus, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OpenStackPlaybookGeneratorDefaults) DeepCopyInto(out *OpenStackPlaybookGeneratorDefaults) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OpenStackPlaybookGeneratorDefaults.
func (in *OpenStackPlaybookGeneratorDefaults) DeepCopy() *OpenStackPlaybookGeneratorDefaults {
	if in == nil {
		return nil
	}
	out := new(OpenStackPlaybookGeneratorDefaults)
	in.DeepCopyInto(out)
	return out
}
