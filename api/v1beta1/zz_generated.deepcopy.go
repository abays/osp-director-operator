...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ControllerHostStatus) DeepCopyInto(out *ControllerHostStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ControllerHostStatus.
func (in *ControllerHostStatus) DeepCopy() *ControllerHostStatus {
	if in == nil {
		return nil
	}
	out := new(ControllerHostStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ControllerVMStatus) DeepCopyInto(out *ControllerVMStatus) {
	*out = *in
	...
	if in.ControllerHosts != nil {
		in, out := &in.ControllerHosts, &out.ControllerHosts
		*out = make(map[string]ControllerHostStatus, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
